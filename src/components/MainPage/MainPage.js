          ...
          <div className="functions__wrapper">
            <div className="functions__wrapper__line">
              <Switch>
                ...
                <Route path="/search">
                  <h2 className="functions__title">Tape m'en vin !</h2>
                  <p className="functions__desc">
                  Tu connais le nom de ton AOC et tu cherches sa localité dans notre Belle France ? 
                  Écris son nom ici mais sois pinard, on s'occupe du reste !
                  </p>
                  <SearchBar
                ...
                <Route path="/map">
                  <h2 className="functions__title">La Carte des Vins</h2>
                  <p className="functions__desc">
                  Tu es curieux de savoir quelles AOC sont présentes dans une région française spécifique ? 
                  Cépage la mer à boire, il suffit de cliquer sur la carte !
                  </p>
                  <Map
                    afterClick={this.setCoords}
                    searchMethod={this.setSearchMethod}
                ...
                <Route path="/geolocation">
                  <h2 className="functions__title">Allez viens, je t'emmène au vin</h2>
                  <p className="functions__desc">
                  Tu veux connaître les AOC de ta région ? 
                  Géolocalise-toi et... TANIN, elles apparaissent comme par magie autour de toi !
                  </p>
                  <GeoButton
                    afterClick={this.setCoords}
                    changeView={view => this.diviseScreen(view)}
